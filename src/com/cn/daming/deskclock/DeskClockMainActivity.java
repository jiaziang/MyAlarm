...
public class DeskClockMainActivity extends Activity implements OnItemClickListener{
    ...
    private void updateLayout() {
        ...
        mAlarmsList = (ListView) findViewById(R.id.alarms_list);       //显示闹钟的ListView
...
/*        View addAlarm = findViewById(R.id.add_alarm);
        ...
        // Make the entire view selected when focused.   让整个View都点击时被选中
    ...
    public boolean onContextItemSelected(final MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.delete_alarm:
                // Confirm that the alarm will be deleted.   删除闹钟～～～～～～～～～～～～～～～～～～～～～～～`
