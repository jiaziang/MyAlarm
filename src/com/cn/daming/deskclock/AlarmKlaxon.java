 ...
 */
//管理闹钟的状态，如果其他应用暂时覆盖了响铃界面  之后可继续响铃
public class AlarmKlaxon extends Service {
    ...
    public void onCreate() {
        ...
        // Listen for incoming calls to kill the alarm.  监听电话事件
        mTelephonyManager =
    ...
    // Do the common stuff when starting the alarm.     播放闹钟前准备工作
    ...
    /**最大响铃时间  ALARM_TIMEOUT_SECONDS=600s
